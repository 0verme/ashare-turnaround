...
DATASET_SPECS: dict[str, DatasetSpec] = {
    ...
    "income": _spec(
        "income",
        primary_keys=("ts_code", "end_date", "report_type", "update_flag"),
    ...
    "fina_mainbz": _spec(
        "fina_mainbz",
        primary_keys=("ts_code", "end_date", "bz_item", "type", "update_flag"),
        partition_strategy="year",
        partition_field="end_date",
    ...
    "forecast": _spec(
        "forecast",
        primary_keys=("ts_code", "end_date", "type", "ann_date"),
        partition_strategy="year",
        partition_field="end_date",
        date_fields=("ann_date", "end_date", "first_ann_date"),
        pit_fields=("end_date", "ann_date", "first_ann_date", "type"),
        required_fields=("ts_code", "ann_date", "end_date", "type"),
    ),
    "express": _spec(
        "express",
